...
//------------------------------------- BASIC CONFIGURATION !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   ** FROM y TO                                                                                    *
   *************************************************************************************************/
  define('DEX_SEND_EMAIL_FROM', 'americandouglas@a2plcpnl0451.prod.iad2.secureserver.net');
  define('DEX_FIX_DESTINATION_EMAIL', 'sarah@dreamfactoryagency.com, jraimonde@americandouglasmetals.com');

  /*************************************************************************************************
   ** Email subject, you can change it here                                                        *
   *************************************************************************************************/
  $emailsubject = 'SwimMirror Contact Form Submission';
   ...
   *************************************************************************************************/
  define('DEX_FROM_EMAIL_FIELD_NAME', '');
  ...
  $excluded_fields[] = "g-recaptcha-response";
